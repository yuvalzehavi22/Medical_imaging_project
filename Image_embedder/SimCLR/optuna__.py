...
def objective(trial):
    ...
    #setattr(args, 'arch', trial.suggest_categorical("arch", ['resnet18', 'resnet50', 'biomedclip']))
    ...
    setattr(args, 'seed', trial.suggest_categorical("seed", [123, 42, 0]))  # Suggesting categorical seed values
    ...
    train_image_dir = 'training_extracted_images'
    ...
    val_image_dir = 'validation_extracted_images'
