...
class embedder:
    ...
    def __init__(self, args):
        ...
        features = [process.preprocess_features(feature) for feature in features] #Each feature matrix is preprocessed (e.g., normalization or scaling) to be suitable for graph neural network training.
